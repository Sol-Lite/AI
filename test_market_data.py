...
TEST_CASES = [
    ...
    #     "desc":          "랭킹 - 거래대금",
    # },
    # ── index: 국내 (API code: 001=KOSPI, 301=KOSDAQ) ─────────────────────────
    # {
    ...
    #     "expected_type": "index",
    #     "expected_args": None,
    #     "desc":          "지수 - 코스피 + 코스닥 복수 조회",
    # },
    # # ── index: 해외 (API code: SPI@SPX=S&P500, NAS@IXIC=NASDAQ) ──────────────
    # # ※ NAS@IXIC(NASDAQ): API가 price=null 반환 → "현재 조회 불가" 안내
    # # ※ 다우존스, 닛케이, 항셍: API 미지원 → "현재 조회 불가" 안내
    # {
    #     "group":         "get_market_data / index",
    #     "message":       "S&P 500 지수 알려줘",
    #     "expected_tool": "get_market_data",
    #     "expected_type": "index",
    #     "expected_args": None,
    #     "desc":          "지수 - S&P 500 (code:SPI@SPX, 정상 데이터)",
    # },
    # {
    #     "group":         "get_market_data / index",
    #     "message":       "나스닥 지금 얼마야",
    ...
    #     "expected_type": "index",
    #     "expected_args": None,
    #     "desc":          "지수 - 나스닥 (code:NAS@IXIC, price=null → 조회 불가 안내)",
    # },
    # {
    #     "group":         "get_market_data / index",
    #     "message":       "다우존스 지수",
